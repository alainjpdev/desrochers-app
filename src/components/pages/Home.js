 ...
 const poly_11 = [ 
  ...
  let labelIndex = 0;
    ...
    const iconChange = (data) => {
      if (icon && apartmentsData.properties.ID == icon.properties.ID) {
        return "https://img.icons8.com/color-glass/48/000000/place-marker.png"
      } else {
        return "https://img.icons8.com/color-glass/48/000000/place-marker.png"
      }
    }
    ...
    <GoogleMap
      ...
      > 
        ...
        {selectedAparment && (
            <InfoWindowOptions
                 position={{ 
                    lat: selectedAparment.geometry.coordinates[1] + 0.00003,
                    lng: selectedAparment.geometry.coordinates[0]  + 0.00003
                 }}
                 onCloseClick={()=>{
